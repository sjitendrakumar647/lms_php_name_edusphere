...
<div class="sidebar bg-white p-4 rounded shadow-sm col-md-11">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item list-group-item-action active d-flex align-items-center">
            ...
            <a href="dashboard_student.php" class="text-white text-decoration-none flex-grow-1">My Class</a>
        </li>
        ...
        <li class="list-group-item list-group-item-action d-flex align-items-center">
            ...
            <a href="message/student_message.php" class="text-dark text-decoration-none flex-grow-1">Messages</a>
