...
mysqli_query($conn,"insert into teacher_class (teacher_id,subject_id,class_id,thumbnails,school_year) values('$session_id','$subject_id','$class_id','uploads/thumbnails.jpg','$school_year')")or die(mysqli_error());
