...
<div class="col-md-3 d-none d-lg-block mt-4" id="sidebar">
    ...
    <!-- Sidebar Navigation -->
    <ul class="nav flex-column mt-3 card shadow-sm" style="background-color: #343a40; border-radius: 10px;">
        <li class="nav-item">
        ...
        <li class="nav-item"><a href="../message/teacher_message.php" class="nav-link"><i class="bi bi-envelope"></i> Message</a></li>
        ...
        <li class="nav-item"><a href="teacher_quiz.php" class="nav-link active"><i class="bi bi-ui-checks-grid"></i> Quiz</a></li>
