    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs mb-3">
                <li class="nav-item">
                    <a class="nav-link active" href="teacher_message.php"><i class="bi bi-person"></i> For Teacher</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="teacher_message_teacher.php"><i class="bi bi-people"></i> For Student</a>
                </li>
            </ul>
            ...
            <form method="post" id="send_message">
                <!-- Recipient Selection -->
                <div class="mb-3">
                    <label for="teacherSelect" class="form-label">To:</label>
