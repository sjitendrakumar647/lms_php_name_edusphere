...
<div class="card shadow-sm">
    <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bi bi-people-fill"></i> Student List</h5>
    </div>
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between mb-3">
            <div>
                ...
                <a href="unreg_students.php" class="btn btn-secondary btn-sm">Unregistered</a>
                <a href="reg_students.php" class="btn btn-primary btn-sm">Registered</a>
            </div>
